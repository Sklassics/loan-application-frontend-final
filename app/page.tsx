       ...
       Login
        ...
        <span className="absolute bottom-0 right-[-10%] w-0 h-[120%] border-[#1ea664] bg-[#1ea664] skew-x-[0deg] transition-all duration-300 group-hover:w-[62%] z-[-1]"></span>
            ...
            <Link href="/register" className="hidden md:block">
              <Button className="relative overflow-hidden group bg-gradient-to-r border from-violet-150 to-violet-150 ">
                ...
                {isVisible.hero && (
                  <>
                    <motion.div 
                      ...
                      className="space-y-2"
                    >
                      <h1 className="text-xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-slate-800  ">
