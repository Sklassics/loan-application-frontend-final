      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.6 }} className="mt-8 text-center">
            <button onClick={() => setShowAll(!showAll)} className="border border-violet-150 text-violet-150 px-4 py-2 rounded-lg hover:bg-violet-150 hover:text-white transition-all duration-300">
